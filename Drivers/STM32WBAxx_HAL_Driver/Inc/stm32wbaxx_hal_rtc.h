...
#ifndef STM32WBAxx_HAL_RTC_H
#define STM32WBAxx_HAL_RTC_H
...
typedef enum
{
  ...
  HAL_RTC_INTERNAL_TAMPER3_EVENT_CB_ID  = 11U,  /*!< RTC Internal Tamper 3 Callback ID  */
  HAL_RTC_INTERNAL_TAMPER5_EVENT_CB_ID  = 12U,  /*!< RTC Internal Tamper 5 Callback ID  */
  HAL_RTC_INTERNAL_TAMPER6_EVENT_CB_ID  = 13U,  /*!< RTC Internal Tamper 6 Callback ID  */
  HAL_RTC_INTERNAL_TAMPER7_EVENT_CB_ID  = 14U,  /*!< RTC Internal Tamper 7 Callback ID  */
  HAL_RTC_INTERNAL_TAMPER8_EVENT_CB_ID  = 15U,  /*!< RTC Internal Tamper 8 Callback ID  */
  HAL_RTC_INTERNAL_TAMPER9_EVENT_CB_ID  = 16U,  /*!< RTC Internal Tamper 9 Callback ID  */
  HAL_RTC_INTERNAL_TAMPER11_EVENT_CB_ID = 17U,  /*!< RTC Internal Tamper 11 Callback ID */
  HAL_RTC_INTERNAL_TAMPER12_EVENT_CB_ID = 18U,  /*!< RTC Internal Tamper 12 Callback ID */
  HAL_RTC_INTERNAL_TAMPER13_EVENT_CB_ID = 19U,  /*!< RTC Internal Tamper 13 Callback ID */
...
#define RTC_FLAG_TSOVF                      (8U)               /*!< Time-stamp overflow flag       */
#define RTC_FLAG_TSF                        (9U)               /*!< Time-stamp flag                */
#define RTC_FLAG_WUTF                       (10U)              /*!< Wakeup timer flag              */
#define RTC_FLAG_ALRBF                      (11U)              /*!< Alarm B flag                   */
#define RTC_FLAG_ALRAF                      (12U)              /*!< Alarm A flag                   */
/**
  * @}
  */
...
#include "stm32wbaxx_hal_rtc_ex.h"
